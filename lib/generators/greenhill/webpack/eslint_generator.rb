  ...
  module Webpack
    module Generators
      class EslintGenerator < Rails::Generators::Base
        ...
        def install_eslint
          run "yarn add -D eslint eslint-plugin-react eslint-plugin-react-hooks eslint-plugin-import eslint-plugin-jsx-a11y @typescript-eslint/eslint-plugin @typescript-eslint/parser"
